...
public class MNItems {
    ...
    public static final RegistryObject<Item> MODULE_HEAT_RESISTANT = ITEMS.register("module_heat_resistive",() -> IModuleHelper.INSTANCE.createModuleItem(MNModuleData.HEAT_RESISTIVE_MODULE_DATA, new Item.Properties().stacksTo(4)));
}
