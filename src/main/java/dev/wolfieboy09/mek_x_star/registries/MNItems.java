...
public class MNItems {
    ...
    public static final RegistryObject<Item> MODULE_OXYGEN_TANK_EXPANSION = ITEMS.register("module_oxygen_tank_expansion",() -> IModuleHelper.INSTANCE.createModuleItem(MNModuleData.OXYGEN_TANK_EXPANSION_MODULE_DATA, new Item.Properties()));
