...
public class MNModules {
    ...
    public static final RegistryObject<ModuleData<ModuleHeatResistant>> MODULE_HEAT_RESISTANT = MODULES.register("module_heat_resistant", () -> MNModuleData.HEAT_RESISTANT_MODULE_DATA);
}
